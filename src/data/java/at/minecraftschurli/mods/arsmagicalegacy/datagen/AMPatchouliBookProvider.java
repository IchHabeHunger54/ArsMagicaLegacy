...
public final class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(HolderLookup.Provider lookupProvider, Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("items", "Items", "", new ItemStackTemplate(AMItems.PURIFIED_VINTEUM_DUST.get()))
            ...
            // TODO render pipelines .addSimpleTextPage("The Magitech Goggles are a fancy piece of armor that can be equipped in the helmet slot, or the head slot if Curios is installed. When wearing the Goggles, $(l:mechanics/etherium)Etherium$() connections will become visible to you.")
            .addSimpleTextPage("The Magitech Goggles are a fancy piece of armor that can be equipped in the helmet slot, or the head slot if Curios is installed. When wearing the Goggles, $(l:mechanics/etherium)Etherium$() connections used to become visible to you, however this ability has since been lost to time.")
