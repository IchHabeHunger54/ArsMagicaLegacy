...
public abstract class ParticleSpawnerProvider extends AbstractDataProvider<ParticleSpawner, ParticleSpawnerBuilder> {
     ...
     * @param type     The spawned particles' {@link ParticleType}.
     ...
     */
    public ParticleSpawnerBuilder builder(ResourceLocation id, ParticleType<?> type, int count, int lifetime) {
        ParticleSpawnerBuilder builder = new ParticleSpawnerBuilder(id, type, count, lifetime);
        add(builder);
        return builder;
    }
}
