...
public final class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(HolderLookup.Provider lookupProvider, Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("entities", "Entities", "", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            // TODO guardians
            .addSubCategory("bosses", "Bosses", "", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            .addEntry("water_guardian", "Water Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 10").build()
            ...
            .build()
            .addEntry("fire_guardian", "Fire Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 90").build()
            ...
            .build()
            .addEntry("earth_guardian", "Earth Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 20").build()
            ...
            .build()
            .addEntry("air_guardian", "Air Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 30").build()
            ...
            .build()
            .addEntry("ice_guardian", "Ice Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 60").build()
            ...
            .build()
            .addEntry("lightning_guardian", "Lightning Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 80").build()
            ...
            .build()
            .addEntry("nature_guardian", "Nature Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 70").build()
            ...
            .build()
            .addEntry("life_guardian", "Life Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 50").build()
            ...
            .build()
            .addEntry("arcane_guardian", "Arcane Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 40").build()
            ...
            .build()
            .addEntry("ender_guardian", "Ender Guardian", new ItemStackTemplate(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .addEntityPage(AMEntities.MANA_CREEPER.getId()).setText("Recommended magic level: 100").build()
