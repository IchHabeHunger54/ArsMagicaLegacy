...
import at.minecraftschurli.arsmagicalegacy.block.RedstoneInlayBlock;
...
public interface AMBlocks {
    ...
    DeferredBlock<WallTorchBlock>              VINTEUM_WALL_TORCH          = register("vinteum_wall_torch",          p -> new WallTorchBlock(ParticleTypes.SMOKE, p), copyProperties(Blocks.WALL_TORCH, p -> p.overrideLootTable(VINTEUM_TORCH.get().getLootTable())));
    DeferredBlock<DropExperienceBlock>         CHIMERITE_ORE               = register("chimerite_ore",               p -> new DropExperienceBlock(UniformInt.of(0, 2), p), properties(p -> p.requiresCorrectToolForDrops().strength(3f, 3f)));
    ...
    DeferredBlock<DropExperienceBlock>         TOPAZ_ORE                   = register("topaz_ore",                   p -> new DropExperienceBlock(UniformInt.of(0, 2), p), properties(p -> p.requiresCorrectToolForDrops().strength(3f, 3f)));
    ...
    DeferredBlock<DropExperienceBlock>         VINTEUM_ORE                 = register("vinteum_ore",                 p -> new DropExperienceBlock(UniformInt.of(1, 3), p), properties(p -> p.requiresCorrectToolForDrops().strength(3f, 3f)));
    ...
    DeferredBlock<DropExperienceBlock>         MOONSTONE_ORE               = register("moonstone_ore",               p -> new DropExperienceBlock(UniformInt.of(3, 7), p), properties(p -> p.requiresCorrectToolForDrops().strength(3f, 3f)));
    ...
    DeferredBlock<WallSignBlock>               WITCHWOOD_WALL_SIGN         = register("witchwood_wall_sign",         p -> new WallSignBlock(WITCHWOOD_WOOD_TYPE, p), copyProperties(Blocks.OAK_WALL_SIGN, p -> p.mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).overrideLootTable(WITCHWOOD_SIGN.get().getLootTable())));
    ...
    DeferredBlock<WallHangingSignBlock>        WITCHWOOD_WALL_HANGING_SIGN = register("witchwood_wall_hanging_sign", p -> new WallHangingSignBlock(WITCHWOOD_WOOD_TYPE, p), copyProperties(Blocks.OAK_WALL_HANGING_SIGN, p -> p.mapColor(MapColor.TERRACOTTA_LIGHT_BLUE).overrideLootTable(WITCHWOOD_HANGING_SIGN.get().getLootTable())));
