...
public final class AMLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        skillTranslation(AMSpells.AGILITY.getId(), "Agility", "Seems like you won't be catching me anytime soon.", "components", "You managed to gain step-up abilities, greater jump height and reduced fall damage.");
        ...
        //skillTranslation(AMSpells.DISMEMBERING.getId(), "[WIP] Dismembering", "Wasn't me. I swear he had no head when I came in.", "modifiers", "You like souvenirs so much that you have discovered how to make your damaging spells leave some pieces intact.$(br2)Each modifier adds a 5%% chance to drop a head when defeating an enemy.");
        ...
        skillTranslation(AMSpells.HARVEST.getId(), "Harvest", "Add a hammer and start a revolution.", "components", "You can cause all plants, leaves, and flowers to be harvested.");
        ...
        skillTranslation(AMSpells.MANA_DRAIN.getId(), "Mana Drain", "So much pools at my disposal!", "components", "You can create a parasitic bond with the target's aura, draining their mana and boosting your own.");
        ...
        skillTranslation(AMSpells.PLANT.getId(), "Plant", "Why bother using hand when magic can do the same?", "components", "You can cause seeds from your inventory to be planted in the ground, if conditions are right for it to grow.$(br2)Best coupled with $(l:shapes/aoe)AoE$() for rapid planting.");
        ...
        //skillTranslation(AMSpells.TELEKINESIS.getId(), "[WIP] Telekinesis", "Up, down, up, down, I think you get the idea.", "components", "You can use your magic to amplify your brainwaves, giving them physical form. These waves can be used to pull entities towards a point in front of you.$(br2)Rolling the mouse wheel while using the spell can change the distance of the point closer or farther away from you.");
        ...
        //skillTranslation(AMTalents.SHIELD_OVERLOAD.location(), "Shield Overload", "No more wasting excess mana.", "talents", "When your mana bar is full, excess mana regenerated turns into a shield that protects you from 5%% of all incoming damage.");
