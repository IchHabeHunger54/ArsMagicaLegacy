...
public class FireGuardian extends AbstractBoss {
    ...
    protected void registerGoals() {
        ...
        goalSelector.addGoal(1, new ExecuteBossSpellGoal<>(this, ArsMagicaApi.id("fire_bolt"), 20));
        goalSelector.addGoal(1, new ExecuteBossSpellGoal<>(this, ArsMagicaApi.id("strong_fire_bolt"), 20));
        goalSelector.addGoal(1, new ExecuteBossSpellGoal<>(this, ArsMagicaApi.id("melt_armor"), 20));
    }
