...
public interface AMDataComponents {
    ...
    DeferredHolder<DataComponentType<?>, DataComponentType<Component>>                      SPELL_NAME                  = register("spell_name",                  ComponentSerialization.CODEC,         ComponentSerialization.STREAM_CODEC);
    DeferredHolder<DataComponentType<?>, DataComponentType<Identifier>>                     SPELL_ICON                  = register("spell_icon",                  Identifier.CODEC,                     Identifier.STREAM_CODEC); 
    DeferredHolder<DataComponentType<?>, DataComponentType<SpellDataComponentMap>>          SPELL_DATA                  = register("spell_data",                  SpellDataComponentMap.CODEC,          SpellDataComponentMap.STREAM_CODEC);
    DeferredHolder<DataComponentType<?>, DataComponentType<Byte>>                           SPELL_SHAPE_GROUP           = register("spell_shape_group",           Codec.BYTE,                           ByteBufCodecs.BYTE);
