...
public class Touch extends PrimarySpellShape {
    ...
    public Spell cast(Spell spell, List<SpellModifier> modifiers, LivingEntity caster) {
        ...
        boolean targetNonSolid = ArsMagicaApi.spellHelper().getModifiedStat(0, AMSpells.TARGET_NON_SOLID_STAT, modifiers, spell, caster, caster, null) > 0;
        ...
        if (result.getType() == HitResult.Type.ENTITY) {
            ArsMagicaApi.spellHelper().castSecondaryOrGrammar(spell, caster, caster, result);
        } else {
