...
public interface AMBlocks {
    ...
    DeferredBlock<SpellcraftingAltarCoreBlock> SPELLCRAFTING_ALTAR_CORE    = register("spellcrafting_altar_core",    SpellcraftingAltarCoreBlock::new, properties().mapColor(MapColor.METAL).strength(3));
