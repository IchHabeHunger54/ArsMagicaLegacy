...
final class AMPatchouliBookProvider extends PatchouliBookProvider {
    ...
    protected void addBooks(HolderLookup.Provider lookupProvider, Consumer<BookBuilder<?, ?, ?>> consumer) {
        ...
        builder.addCategory("entities", "Entities", "", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            // TODO guardians
            .addSubCategory("bosses", "Bosses", "", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            .addEntry("water_guardian", "Water Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("fire_guardian", "Fire Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("earth_guardian", "Earth Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("air_guardian", "Air Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("ice_guardian", "Ice Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("lightning_guardian", "Lightning Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("nature_guardian", "Nature Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("life_guardian", "Life Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("arcane_guardian", "Arcane Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
            ...
            .build()
            .addEntry("ender_guardian", "Ender Guardian", new ItemStack(AMItems.MANA_CREEPER_SPAWN_EGG.get()))
