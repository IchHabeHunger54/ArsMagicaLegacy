...
import at.minecraftschurli.mods.arsmagicalegacy.item.FireAntennaItem;
...
public interface AMItems {
    ...
    DeferredItem<Item>                                  WATER_ORBS                       = ITEMS.registerItem("water_orbs", WaterOrbsItem::new);
    DeferredItem<Item>                                  FIRE_ANTENNA                     = ITEMS.registerItem("fire_antenna", FireAntennaItem::new);
    DeferredItem<Item>                                  EARTH_ARMOR                      = ITEMS.registerItem("earth_armor", EarthArmorItem::new);
    DeferredItem<Item>                                  AIR_SLED                         = ITEMS.registerItem("air_sled", AirSledItem::new);
    DeferredItem<WintersGraspItem>                      WINTERS_GRASP                    = ITEMS.registerItem("winters_grasp", p -> new WintersGraspItem(p.stacksTo(1)));
    DeferredItem<Item>                                  LIGHTNING_CHARM                  = ITEMS.registerItem("lightning_charm", LightningCharmItem::new);
    DeferredItem<NatureScytheItem>                      NATURE_SCYTHE                    = ITEMS.registerItem("nature_scythe", p -> new NatureScytheItem(p.stacksTo(1)));
    DeferredItem<Item>                                  LIFE_SHIELD                      = ITEMS.registerItem("life_shield", LifeShieldItem::new);
    DeferredItem<Item>                                  ARCANE_SPELL_BOOK                = ITEMS.registerItem("arcane_spell_book", ArcaneSpellBookItem::new);
    DeferredItem<Item>                                  ENDER_BOOTS                      = ITEMS.registerItem("ender_boots", EnderBootsItem::new);
