...
public final class AMRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.WATER).withCount(2))
            ...
            .pattern("AIA")
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.WATER), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.FIRE).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.FIRE), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.EARTH).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.EARTH), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.AIR).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.AIR), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.ICE).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.ICE), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.LIGHTNING).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.LIGHTNING), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.NATURE).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.NATURE), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.LIFE).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.LIFE), AMItems.AFFINITY_ESSENCE))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.ARCANE).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.ARCANE), AMItems.AFFINITY_ESSENCE))
            .unlockedBy(getHasName(AMItems.ARCANE_ASH.get()), has(AMTags.Items.DUSTS_ARCANE_ASH))
        ...
        ShapedRecipeBuilder.shaped(items, RecipeCategory.MISC, affinityEssence(affinities, AMMagic.ENDER).withCount(2))
            ...
            .define('A', AMTags.Items.DUSTS_ARCANE_ASH)
            .define('E', AMTags.Items.DUSTS_PURIFIED_VINTEUM)
            // TODO .define('E', DataComponentIngredient.of(false, AMDataComponents.AFFINITY, affinities.getOrThrow(AMMagic.ENDER), AMItems.AFFINITY_ESSENCE))
