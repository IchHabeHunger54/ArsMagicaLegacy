...
public final class AMMultiblocks {
    ...
    public static final ResourceLocation WATER_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("water_guardian_spawn_ritual");
    public static final ResourceLocation FIRE_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("fire_guardian_spawn_ritual");
    public static final ResourceLocation EARTH_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("earth_guardian_spawn_ritual");
    public static final ResourceLocation AIR_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("air_guardian_spawn_ritual");
    public static final ResourceLocation ICE_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("ice_guardian_spawn_ritual");
    public static final ResourceLocation LIGHTNING_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("lightning_guardian_spawn_ritual");
    public static final ResourceLocation LIFE_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("life_guardian_spawn_ritual");
    public static final ResourceLocation ARCANE_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("arcane_guardian_spawn_ritual");
    public static final ResourceLocation ENDER_GUARDIAN_SPAWN_RITUAL = ArsMagicaApi.id("ender_guardian_spawn_ritual");
