...
public class FallingStar extends SpellComponent {
    ...
    public SpellComponentCastResult cast(List<SpellModifier> modifiers, SpellCastContext context) {
        ...
        if (level.dimensionType().hasCeiling()) return SpellComponentCastResult.failure(AMTranslations.SPELL_FAIL_COMPONENT_FALLING_STAR);
        ...
        fallingStar.setColor(helper.getColor(modifiers, context.spellData(), -1));
