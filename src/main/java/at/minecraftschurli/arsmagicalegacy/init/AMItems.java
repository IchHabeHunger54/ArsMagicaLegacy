...
public interface AMItems {
    ...
    DeferredItem<ArmorItem>                                    MAGITECH_GOGGLES                 = ITEMS.registerItem("magitech_goggles", p -> new ArmorItem(AMArmorMaterials.MAGITECH_GOGGLES, ArmorItem.Type.HELMET, p.stacksTo(1)));
