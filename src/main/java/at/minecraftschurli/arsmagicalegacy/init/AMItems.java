...
public interface AMItems {
    ...
    DeferredItem<DataComponentNamedItem<Holder<EtheriumType>>> ETHERIUM_PLACEHOLDER             = AMRegistries.ITEMS.registerItem("etherium_placeholder", p -> new DataComponentNamedItem<>(p, AMDataComponents.ETHERIUM_TYPE.get()).withTranslationKeyGetter((holder, name) -> Util.makeDescriptionId(name, holder.getKey().location())));
    ...
    DeferredItem<BlockItem>                                    CELESTIAL_PRISM                  = AMRegistries.ITEMS.registerSimpleBlockItem(AMBlocks.CELESTIAL_PRISM);
    ...
    DeferredItem<Item>                                         MAGENTA_RUNE                     = AMRegistries.ITEMS.registerSimpleItem("magenta_rune");
    DeferredItem<Item>                                         LIGHT_BLUE_RUNE                  = AMRegistries.ITEMS.registerSimpleItem("light_blue_rune");
    DeferredItem<Item>                                         YELLOW_RUNE                      = AMRegistries.ITEMS.registerSimpleItem("yellow_rune");
    DeferredItem<Item>                                         LIME_RUNE                        = AMRegistries.ITEMS.registerSimpleItem("lime_rune");
    DeferredItem<Item>                                         PINK_RUNE                        = AMRegistries.ITEMS.registerSimpleItem("pink_rune");
    DeferredItem<Item>                                         GRAY_RUNE                        = AMRegistries.ITEMS.registerSimpleItem("gray_rune");
    DeferredItem<Item>                                         LIGHT_GRAY_RUNE                  = AMRegistries.ITEMS.registerSimpleItem("light_gray_rune");
    DeferredItem<Item>                                         CYAN_RUNE                        = AMRegistries.ITEMS.registerSimpleItem("cyan_rune");
    DeferredItem<Item>                                         PURPLE_RUNE                      = AMRegistries.ITEMS.registerSimpleItem("purple_rune");
    DeferredItem<Item>                                         BLUE_RUNE                        = AMRegistries.ITEMS.registerSimpleItem("blue_rune");
    DeferredItem<Item>                                         BROWN_RUNE                       = AMRegistries.ITEMS.registerSimpleItem("brown_rune");
