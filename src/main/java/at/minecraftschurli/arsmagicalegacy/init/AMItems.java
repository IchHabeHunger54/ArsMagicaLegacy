...
public interface AMItems {
    ...
    DeferredItem<ArmorItem>                                    MAGITECH_GOGGLES                 = ITEMS.registerItem("magitech_goggles", p -> new ArmorItem(AMArmorMaterials.MAGITECH_GOGGLES, ArmorItem.Type.HELMET, p.stacksTo(1).durability(100)));
    DeferredItem<ManaArmorItem>                                MAGE_HELMET                      = ITEMS.registerItem("mage_helmet", p -> new ManaArmorItem(AMArmorMaterials.MAGE, ArmorItem.Type.HELMET, p, 8, 5));
    DeferredItem<ManaArmorItem>                                MAGE_CHESTPLATE                  = ITEMS.registerItem("mage_chestplate", p -> new ManaArmorItem(AMArmorMaterials.MAGE, ArmorItem.Type.CHESTPLATE, p, 8, 5));
    DeferredItem<ManaArmorItem>                                MAGE_LEGGINGS                    = ITEMS.registerItem("mage_leggings", p -> new ManaArmorItem(AMArmorMaterials.MAGE, ArmorItem.Type.LEGGINGS, p, 8, 5));
    DeferredItem<ManaArmorItem>                                MAGE_BOOTS                       = ITEMS.registerItem("mage_boots", p -> new ManaArmorItem(AMArmorMaterials.MAGE, ArmorItem.Type.BOOTS, p, 8, 5));
    DeferredItem<ManaArmorItem>                                BATTLEMAGE_HELMET                = ITEMS.registerItem("battlemage_helmet", p -> new ManaArmorItem(AMArmorMaterials.BATTLEMAGE, ArmorItem.Type.HELMET, p, 12, 10));
    DeferredItem<ManaArmorItem>                                BATTLEMAGE_CHESTPLATE            = ITEMS.registerItem("battlemage_chestplate", p -> new ManaArmorItem(AMArmorMaterials.BATTLEMAGE, ArmorItem.Type.CHESTPLATE, p, 12, 10));
    DeferredItem<ManaArmorItem>                                BATTLEMAGE_LEGGINGS              = ITEMS.registerItem("battlemage_leggings", p -> new ManaArmorItem(AMArmorMaterials.BATTLEMAGE, ArmorItem.Type.LEGGINGS, p, 12, 10));
    DeferredItem<ManaArmorItem>                                BATTLEMAGE_BOOTS                 = ITEMS.registerItem("battlemage_boots", p -> new ManaArmorItem(AMArmorMaterials.BATTLEMAGE, ArmorItem.Type.BOOTS, p, 12, 10));
