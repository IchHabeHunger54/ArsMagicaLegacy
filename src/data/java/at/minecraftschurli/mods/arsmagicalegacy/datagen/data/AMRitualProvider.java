...
public final class AMRitualProvider extends RitualProvider {
    ...
    public void generate(HolderLookup.Provider provider) {
        ...
        spawn(AMEntities.WATER_GUARDIAN, AMMultiblocks.WATER_GUARDIAN_SPAWN_RITUAL,
        ...
        spawn(AMEntities.FIRE_GUARDIAN, AMMultiblocks.FIRE_GUARDIAN_SPAWN_RITUAL,
        ...
        spawn(AMEntities.EARTH_GUARDIAN, AMMultiblocks.EARTH_GUARDIAN_SPAWN_RITUAL,
            ...
            .addRequirement(new DimensionRitualRequirement(Level.OVERWORLD));
        spawn(AMEntities.AIR_GUARDIAN, AMMultiblocks.AIR_GUARDIAN_SPAWN_RITUAL,
        ...
        spawn(AMEntities.ICE_GUARDIAN, AMMultiblocks.ICE_GUARDIAN_SPAWN_RITUAL,
        ...
        spawn(AMEntities.LIGHTNING_GUARDIAN, AMMultiblocks.LIGHTNING_GUARDIAN_SPAWN_RITUAL, new BlockPos(0, -3, 0),
            new GameEventRitualTrigger(GameEvent.LIGHTNING_STRIKE));
        spawn(AMEntities.LIFE_GUARDIAN, AMMultiblocks.LIFE_GUARDIAN_SPAWN_RITUAL,
        ...
        spawn(AMEntities.ARCANE_GUARDIAN, AMMultiblocks.ARCANE_GUARDIAN_SPAWN_RITUAL,
            new DroppedItemRitualTrigger(DataComponentIngredient.of(true, ArsMagicaApi.book())));
        spawn(AMEntities.ENDER_GUARDIAN, AMMultiblocks.ENDER_GUARDIAN_SPAWN_RITUAL,
            new DroppedItemRitualTrigger(Ingredient.of(Items.ENDER_EYE)))
            .addRequirement(new DimensionRitualRequirement(Level.END));
    }

    private RitualBuilder spawn(DeferredHolder<EntityType<?>, ? extends EntityType<?>> boss, Identifier structure, RitualTrigger<?> trigger) {
        return spawn(boss, structure, BlockPos.ZERO, trigger);
    }

    private RitualBuilder spawn(DeferredHolder<EntityType<?>, ? extends EntityType<?>> boss, Identifier structure, BlockPos offset, RitualTrigger<?> trigger) {
