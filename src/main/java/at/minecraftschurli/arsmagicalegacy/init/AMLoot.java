...
import at.minecraftschurli.arsmagicalegacy.loot.HasContextKeyCondition;
...
public interface AMLoot {
    ...
    DeferredHolder<MapCodec<? extends LootItemCondition>, MapCodec<HasContextKeyCondition>> HAS_LOOT_CONTEXT_PARAM = LOOT_CONDITIONS.register("has_loot_context_param", () -> HasContextKeyCondition.CODEC);
