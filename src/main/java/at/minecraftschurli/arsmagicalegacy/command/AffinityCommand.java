...
public final class AffinityCommand {
    public static void register(LiteralArgumentBuilder<CommandSourceStack> builder, CommandBuildContext context) {
        builder.then(Commands.literal("affinity")
            .then(Commands.literal("add")
                .then(Commands.argument("affinity", ResourceArgument.resource(context, AMRegistryKeys.AFFINITY))
    ...
    private static int addSelf(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        return runSelf(context, DoubleArgumentType.getDouble(context, "amount"), ArsMagicaApi.magicHelper()::addAffinityDepth, (name, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_ADD_SINGLE_KEY, amount, name, Affinity.getName(holder)));
    }

    private static int add(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        return runMultiple(context, DoubleArgumentType.getDouble(context, "amount"), ArsMagicaApi.magicHelper()::addAffinityDepth, (name, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_ADD_SINGLE_KEY, amount, name, Affinity.getName(holder)), (size, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_ADD_MULTIPLE_KEY, amount, size, Affinity.getName(holder)));
    }

    private static int setSelf(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        return runSelf(context, DoubleArgumentType.getDouble(context, "amount"), ArsMagicaApi.magicHelper()::setAffinityDepth, (name, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_SET_SINGLE_KEY, amount, name, Affinity.getName(holder)));
    }

    private static int set(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        return runMultiple(context, DoubleArgumentType.getDouble(context, "amount"), ArsMagicaApi.magicHelper()::setAffinityDepth, (name, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_SET_SINGLE_KEY, amount, name, Affinity.getName(holder)), (size, holder, amount) -> Component.translatable(AMTranslations.COMMAND_AFFINITY_SET_MULTIPLE_KEY, amount, size, Affinity.getName(holder)));
    }

    private static int getSelf(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        Holder<Affinity> holder = ResourceArgument.getResource(context, "affinity", AMRegistryKeys.AFFINITY);
