...
public final class AMLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        //skillTranslation(AMSpells.TELEKINESIS.getId(), "Telekinesis", "Up, down, up, down, I think you get the idea.", "components", "You can use your magic to amplify your brainwaves, giving them physical form. These waves can be used to pull entities towards a point in front of you.$(br2)Rolling the mouse wheel while using the spell can change the distance of the point closer or farther away from you.");
