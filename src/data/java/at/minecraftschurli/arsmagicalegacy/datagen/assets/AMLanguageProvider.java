...
public final class AMLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        configTranslation("magic_advancement", "Completing this advancement will unlock magic for the player. Leave empty to not require an advancement and have magic unlocked from the start.");
        configTranslation("mana_to_burnout_ratio", "The default mana to burnout ratio, used in calculating spell costs.");
        ...
        configTranslation("mana.regeneration", "The multiplier for mana regeneration. Mana regeneration is calculated as (base + multiplier * (level - 1)) * regeneration.");
        ...
        configTranslation("burnout.regeneration", "The multiplier for burnout regeneration. Burnout regeneration is calculated as (base + multiplier * (level - 1)) * regeneration.");
        configTranslation("level.base", "The base value for leveling calculation. XP cost per level is calculated as multiplier * base ^ (level - 1).");
        configTranslation("level.multiplier", "The multiplier for leveling calculation. XP cost per level is calculated as multiplier * base ^ (level - 1).");
        configTranslation("level.extra_skill_points", "The extra blue skill points a player gets at level 1, in addition to the one they already get.");
        ...
        configTranslation("render_level_at_top", "If true, renders the bars in order level number -> level bar -> mana bar -> burnout bar. If false, renders the bars in order mana bar -> burnout bar -> level bar -> level number.");
